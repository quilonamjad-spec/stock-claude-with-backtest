...
def compute_vwap(df: pd.DataFrame) -> pd.DataFrame:
    ...
    volume, resetting at the start of each calendar day present in the
    index. Only meaningful on intraday data (5m/15m/1h) -- if scanning on
    the Daily timeframe, leave the VWAP indicator toggled off in the
    sidebar, since a "daily VWAP" isn't a standard/useful concept.
    """
